...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'fixed_inspection_node = je_software.fixed_inspection_node:main',
            'fixed_slot_provider_node = je_software.fixed_slot_provider_node:main',
            'zmq_motion_backend_node = je_software.zmq_motion_backend_node:main',
            'pcb_process_task_manager_node = je_software.pcb_process_task_manager_node:main',
        ],
    },
)
